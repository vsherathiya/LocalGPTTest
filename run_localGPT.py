...
# load the vectorstore
    ...
    while True:
        ...
        # docs_and_scores1 = db_for_similarity.similarity_search_with_relevance_scores(docs)
        #docs_and_scores1 = db_for_similarity.similarity_search_with_relevance_scores(docs_and_scores[0])
        if docs_and_scores[0][1] < 0.72:# & docs_and_scores1[0][1] < 0.72:
            answer = "Sorry, i am not trained with this information."
        else:
            answer = answer
